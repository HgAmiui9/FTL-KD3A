...
def np_traverse(
    ...
    if (
        ...
        raise ValueError("Seed must be a 1-D or 2-D array of integers.")
...
class WalkForestCollator(object):
    ...
    def __call__(self, molecule):
        ...
        return (
            ...
            torch.as_tensor(label, dytpe=torch.float32),
